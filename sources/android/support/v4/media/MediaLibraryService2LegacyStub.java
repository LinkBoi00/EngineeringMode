...
class MediaLibraryService2LegacyStub extends MediaBrowserServiceCompat {
    ...
    public void onLoadChildren(String parentId, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> result) {
        onLoadChildren(parentId, result, (Bundle) null);
    }
    ...
    public void onLoadChildren(String parentId, MediaBrowserServiceCompat.Result<List<MediaBrowserCompat.MediaItem>> result, Bundle options) {
        ...
        this.mLibrarySession.getCallbackExecutor().execute(new Runnable() {
            public void run() {
                ...
                result2.sendResult(MediaUtils2.convertToMediaItemList(MediaLibraryService2LegacyStub.this.mLibrarySession.getCallback().onGetChildren(MediaLibraryService2LegacyStub.this.mLibrarySession.getInstance(), controller, str, 1, Integer.MAX_VALUE, (Bundle) null)));
            }
        });
    }
