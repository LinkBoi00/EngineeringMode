...
class Cea708CCParser {
    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (windowBitmap) {
            ...
            case Const.CODE_C1_SPC /*145*/:
                int pos8 = pos + 1;
                int pos9 = pos8 + 1;
                emitCaptionEvent(new CaptionEvent(13, new CaptionPenColor(new CaptionColor((data[pos] & 192) >> 6, (data[pos] & 48) >> 4, (data[pos] & 12) >> 2, data[pos] & 3), new CaptionColor((data[pos8] & 192) >> 6, (data[pos8] & 48) >> 4, (data[pos8] & 12) >> 2, data[pos8] & 3), new CaptionColor(0, (data[pos9] & 48) >> 4, (12 & data[pos9]) >> 2, data[pos9] & 3))));
                return pos9 + 1;
            ...
            case Const.CODE_C1_SWA /*151*/:
                ...
                int i = opacity;
                emitCaptionEvent(new CaptionEvent(15, new CaptionWindowAttr(new CaptionColor(opacity, (data[pos] & 48) >> 4, (data[pos] & 12) >> 2, data[pos] & 3), new CaptionColor(0, (data[pos + 1] & 48) >> 4, (data[pos + 1] & 12) >> 2, data[pos + 1] & 3), ((data[pos + 2] & 128) >> 5) | ((data[pos + 1] & 192) >> 6), (data[pos + 2] & 64) != 0, (data[pos + 2] & 48) >> 4, (data[pos + 2] & 12) >> 2, data[pos + 2] & 3, (12 & data[pos + 3]) >> 2, (data[pos + 3] & 240) >> 4, 3 & data[pos + 3])));
                return pos + 4;
            ...
            case 159:
                CaptionWindow captionWindow = r13;
                CaptionWindow captionWindow2 = new CaptionWindow(windowBitmap - 152, (data[pos] & 32) != 0, (data[pos] & 16) != 0, (data[pos] & 8) != 0, data[pos] & 7, (data[pos + 1] & 128) != 0, data[pos + 1] & 127, data[pos + 2] & 255, (data[pos + 3] & 240) >> 4, 15 & data[pos + 3], data[pos + 4] & 63, 7 & data[pos + 5], (data[pos + 5] & 56) >> 3);
    ...
    public static class CaptionColor {
        private static final int[] COLOR_MAP = {0, 15, LastCallFailCause.CALL_BARRED, 255};
        public static final int OPACITY_FLASH = 1;
        private static final int[] OPACITY_MAP = {255, LastCallFailCause.RADIO_LINK_FAILURE, 128, 0};
