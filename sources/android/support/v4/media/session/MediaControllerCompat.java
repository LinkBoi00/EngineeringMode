    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public final void registerCallback(android.support.v4.media.session.MediaControllerCompat.Callback r5, android.os.Handler r6) {
            /*
                ...
                android.support.v4.media.session.MediaSessionCompat$Token r1 = r4.mSessionToken     // Catch:{ RemoteException -> 0x0027 }
                android.support.v4.media.session.IMediaSession r1 = r1.getExtraBinder()     // Catch:{ RemoteException -> 0x0027 }
            ...
            L_0x0030:
                ...
                java.util.List<android.support.v4.media.session.MediaControllerCompat$Callback> r1 = r4.mPendingCallbacks     // Catch:{ all -> 0x003d }
