...
public class MediaSessionCompat {
    ...
    public MediaSessionCompat(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent) {
        this(context, tag, mbrComponent, mbrIntent, (SessionToken2) null);
    }

    public MediaSessionCompat(Context context, String tag, SessionToken2 token2) {
        this(context, tag, (ComponentName) null, (PendingIntent) null, token2);
    }
    ...
    private MediaSessionCompat(Context context, String tag, ComponentName mbrComponent, PendingIntent mbrIntent, SessionToken2 token2) {
        ...
        if (context == null) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                MediaSessionImplApi28 mediaSessionImplApi28 = new MediaSessionImplApi28(context, tag, token2);
                this.mImpl = mediaSessionImplApi28;
                setCallback(new Callback() {
                });
                mediaSessionImplApi28.setMediaButtonReceiver(mbrIntent);
            } else if (Build.VERSION.SDK_INT >= 21) {
                MediaSessionImplApi21 mediaSessionImplApi21 = new MediaSessionImplApi21(context, tag, token2);
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(java.lang.String r8, android.os.Bundle r9, android.os.ResultReceiver r10) {
                /*
                    ...
                    boolean r0 = r8.equals(r0)     // Catch:{ BadParcelableException -> 0x00f1 }
                    r1 = 0
                    if (r0 == 0) goto L_0x0047
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f1 }
                    java.lang.ref.WeakReference r0 = r0.mSessionImpl     // Catch:{ BadParcelableException -> 0x00f1 }
                    java.lang.Object r0 = r0.get()     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.session.MediaSessionCompat$MediaSessionImplApi21 r0 = (android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21) r0     // Catch:{ BadParcelableException -> 0x00f1 }
                    if (r0 == 0) goto L_0x0045
                    android.os.Bundle r2 = new android.os.Bundle     // Catch:{ BadParcelableException -> 0x00f1 }
                    r2.<init>()     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.session.MediaSessionCompat$Token r3 = r0.getSessionToken()     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.session.IMediaSession r4 = r3.getExtraBinder()     // Catch:{ BadParcelableException -> 0x00f1 }
                    java.lang.String r5 = "android.support.v4.media.session.EXTRA_BINDER"
                    if (r4 != 0) goto L_0x002a
                    r6 = r1
                    goto L_0x002e
                L_0x002a:
                    android.os.IBinder r6 = r4.asBinder()     // Catch:{ BadParcelableException -> 0x00f1 }
                L_0x002e:
                    android.support.v4.app.BundleCompat.putBinder(r2, r5, r6)     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.SessionToken2 r5 = r3.getSessionToken2()     // Catch:{ BadParcelableException -> 0x00f1 }
                    java.lang.String r6 = "android.support.v4.media.session.SESSION_TOKEN2"
                    if (r5 != 0) goto L_0x003a
                    goto L_0x003e
                L_0x003a:
                    android.os.Bundle r1 = r5.toBundle()     // Catch:{ BadParcelableException -> 0x00f1 }
                L_0x003e:
                    r2.putBundle(r6, r1)     // Catch:{ BadParcelableException -> 0x00f1 }
                    r1 = 0
                    r10.send(r1, r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                L_0x0045:
                    goto L_0x00f0
                L_0x0047:
                    ...
                    java.lang.ClassLoader r0 = r0.getClassLoader()     // Catch:{ BadParcelableException -> 0x00f1 }
                    r9.setClassLoader(r0)     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.os.Parcelable r1 = r9.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00f1 }
                    r0.onAddQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00f1 }
                    goto L_0x00f0
                L_0x0067:
                    ...
                    android.os.Parcelable r1 = r9.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00f1 }
                    int r2 = r9.getInt(r3)     // Catch:{ BadParcelableException -> 0x00f1 }
                    r0.onAddQueueItem(r1, r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                    goto L_0x00f0
                L_0x008a:
                    ...
                    android.os.Parcelable r1 = r9.getParcelable(r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.MediaDescriptionCompat r1 = (android.support.v4.media.MediaDescriptionCompat) r1     // Catch:{ BadParcelableException -> 0x00f1 }
                    r0.onRemoveQueueItem(r1)     // Catch:{ BadParcelableException -> 0x00f1 }
                    goto L_0x00f0
                L_0x00a7:
                    ...
                    java.util.List r2 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00f1 }
                    if (r2 == 0) goto L_0x00ea
                    r2 = -1
                    int r2 = r9.getInt(r3, r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                    if (r2 < 0) goto L_0x00de
                    java.util.List r3 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00f1 }
                    int r3 = r3.size()     // Catch:{ BadParcelableException -> 0x00f1 }
                    if (r2 >= r3) goto L_0x00de
                    java.util.List r1 = r0.mQueue     // Catch:{ BadParcelableException -> 0x00f1 }
                    java.lang.Object r1 = r1.get(r2)     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.session.MediaSessionCompat$QueueItem r1 = (android.support.v4.media.session.MediaSessionCompat.QueueItem) r1     // Catch:{ BadParcelableException -> 0x00f1 }
                L_0x00de:
                    if (r1 == 0) goto L_0x00ea
                    android.support.v4.media.session.MediaSessionCompat$Callback r3 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f1 }
                    android.support.v4.media.MediaDescriptionCompat r4 = r1.getDescription()     // Catch:{ BadParcelableException -> 0x00f1 }
                    r3.onRemoveQueueItem(r4)     // Catch:{ BadParcelableException -> 0x00f1 }
                L_0x00ea:
                    goto L_0x00f0
                L_0x00eb:
                    android.support.v4.media.session.MediaSessionCompat$Callback r0 = android.support.v4.media.session.MediaSessionCompat.Callback.this     // Catch:{ BadParcelableException -> 0x00f1 }
                    r0.onCommand(r8, r9, r10)     // Catch:{ BadParcelableException -> 0x00f1 }
                L_0x00f0:
                    goto L_0x00f9
                L_0x00f1:
                    r0 = move-exception
    ...
    public static final class Token implements Parcelable {
        ...
        Token(Object inner) {
            this(inner, (IMediaSession) null, (SessionToken2) null);
        }

        Token(Object inner, IMediaSession extraBinder) {
            this(inner, extraBinder, (SessionToken2) null);
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        public MediaSessionManager.RemoteUserInfo getCurrentControllerInfo() {
            synchronized (this.mLock) {
                ...
                MediaSessionManager.RemoteUserInfo remoteUserInfo = messageHandler.getRemoteUserInfo();
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        MediaSessionImplApi21(Context context, String tag, SessionToken2 token2) {
            ...
            this.mToken = new Token(MediaSessionCompatApi21.getSessionToken(createSession), new ExtraSession(), token2);
        }
