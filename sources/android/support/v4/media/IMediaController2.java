        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    if (data.readInt() != 0) {
                        _arg02 = (Bundle) Bundle.CREATOR.createFromParcel(parcel3);
                    } else {
                        _arg02 = null;
                    }
                ...
                case 5:
                    ...
                    List<Bundle> _arg08 = parcel4.createTypedArrayList(Bundle.CREATOR);
                    if (data.readInt() != 0) {
                        _arg1 = (Bundle) Bundle.CREATOR.createFromParcel(parcel4);
                    } else {
                        _arg1 = null;
                    }
                ...
                case 6:
                    ...
                    if (data.readInt() != 0) {
                        _arg03 = (Bundle) Bundle.CREATOR.createFromParcel(parcel5);
                    } else {
                        _arg03 = null;
                    }
                ...
                case 7:
                    ...
                    if (data.readInt() != 0) {
                        _arg04 = (Bundle) Bundle.CREATOR.createFromParcel(parcel6);
                    } else {
                        _arg04 = null;
                    }
                ...
                case 11:
                    ...
                    if (data.readInt() != 0) {
                        _arg12 = (Bundle) Bundle.CREATOR.createFromParcel(parcel7);
                    } else {
                        _arg12 = null;
                    }
                ...
                case 13:
                    ...
                    if (data.readInt() != 0) {
                        _arg122 = (PendingIntent) PendingIntent.CREATOR.createFromParcel(parcel);
                    } else {
                        _arg122 = null;
                    }
                    onConnected(_arg010, _arg13, _arg25, _arg3, _arg43, _arg5, _arg6, _arg7, _arg8, _arg9, _arg10, createTypedArrayList, _arg122);
                    return true;
                case 14:
                ...
                case 21:
                    ...
                    onGetChildrenDone(_arg013, _arg18, _arg26, createTypedArrayList2, _arg4);
                    return true;
                case 22:
                ...
                case 23:
                    ...
                    onGetSearchResultDone(_arg015, _arg110, _arg27, createTypedArrayList3, _arg42);
                    return true;
                case 1598968902:
        ...
        private static class Proxy implements IMediaController2 {
            ...
            public void onConnected(IMediaSession2 sessionBinder, Bundle commandGroup, int playerState, Bundle currentItem, long positionEventTimeMs, long positionMs, float playbackSpeed, long bufferedPositionMs, Bundle playbackInfo, int repeatMode, int shuffleMode, List<Bundle> playlist, PendingIntent sessionActivity) throws RemoteException {
                ...
                try {
                    ...
                    th = th8;
                    int i4 = playerState;
                    long j32 = positionEventTimeMs;
                    long j42 = positionMs;
                    float f222 = playbackSpeed;
                    long j22222 = bufferedPositionMs;
                    int i32222 = repeatMode;
                    int i2222222 = shuffleMode;
                    _data.recycle();
                    throw th;
                }
            }
