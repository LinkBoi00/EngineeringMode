...
class MediaSessionLegacyStub extends MediaSessionCompat.Callback {
    ...
    private void onCommand2(IBinder caller, int commandCode, Session2Runnable runnable) {
        onCommand2Internal(caller, (SessionCommand2) null, commandCode, runnable);
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onCommand2Internal(android.os.IBinder r10, android.support.v4.media.SessionCommand2 r11, int r12, android.support.v4.media.MediaSessionLegacyStub.Session2Runnable r13) {
        /*
            r9 = this;
