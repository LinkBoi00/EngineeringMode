...
class MediaSession2Stub extends IMediaSession2.Stub {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0014, code lost:
        if (r1.hasCommand(r5) == false) goto L_0x0018;
     */
    ...
    public boolean isAllowedCommand(android.support.v4.media.MediaSession2.ControllerInfo r4, android.support.v4.media.SessionCommand2 r5) {
        /*
            r3 = this;
            ...
            boolean r0 = r1.hasCommand((android.support.v4.media.SessionCommand2) r5)
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean isAllowedCommand(android.support.v4.media.MediaSession2.ControllerInfo r4, int r5) {
        /*
            r3 = this;
            java.lang.Object r0 = r3.mLock
            monitor-enter(r0)
            ...
            monitor-exit(r0)     // Catch:{ all -> 0x001d }
            if (r1 == 0) goto L_0x0018
            boolean r0 = r1.hasCommand((int) r5)
            if (r0 == 0) goto L_0x0018
            r0 = 1
            goto L_0x0019
        L_0x0018:
    ...
    private void onSessionCommand(IMediaController2 caller, int commandCode, SessionRunnable runnable) {
        onSessionCommandInternal(caller, (SessionCommand2) null, commandCode, runnable);
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onSessionCommandInternal(android.support.v4.media.IMediaController2 r10, android.support.v4.media.SessionCommand2 r11, int r12, android.support.v4.media.MediaSession2Stub.SessionRunnable r13) {
        /*
            r9 = this;
    ...
    public void addPlaylistItem(IMediaController2 caller, final int index, final Bundle mediaItem) {
        onSessionCommand(caller, 15, (SessionRunnable) new SessionRunnable() {
            public void run(MediaSession2.ControllerInfo controller) throws RemoteException {
                MediaSession2Stub.this.mSession.getInstance().addPlaylistItem(index, MediaItem2.fromBundle(mediaItem, (UUID) null));
            }
        });
    }
    ...
    public void replacePlaylistItem(IMediaController2 caller, final int index, final Bundle mediaItem) {
        onSessionCommand(caller, 17, (SessionRunnable) new SessionRunnable() {
            public void run(MediaSession2.ControllerInfo controller) throws RemoteException {
                MediaSession2Stub.this.mSession.getInstance().replacePlaylistItem(index, MediaItem2.fromBundle(mediaItem, (UUID) null));
            }
        });
    }
