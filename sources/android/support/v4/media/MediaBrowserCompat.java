...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        MediaBrowserImplApi21(Context context, ComponentName serviceComponent, ConnectionCallback callback, Bundle rootHints) {
            ...
            Bundle bundle = new Bundle(rootHints);
    ...
    private static class CallbackHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r12) {
            ...
            L_0x0016:
                ...
                java.lang.Class<android.support.v4.media.session.MediaSessionCompat> r2 = android.support.v4.media.session.MediaSessionCompat.class
                ...
                r10 = 1
                int r3 = r12.what     // Catch:{ BadParcelableException -> 0x009c }
            ...
            L_0x003c:
                goto L_0x0075
            L_0x003d:
                java.lang.String r5 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r3 = "data_media_item_list"
                java.util.ArrayList r6 = r1.getParcelableArrayList(r3)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r3 = "data_options"
                android.os.Bundle r7 = r1.getBundle(r3)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r3 = "data_notify_children_changed_options"
                android.os.Bundle r8 = r1.getBundle(r3)     // Catch:{ BadParcelableException -> 0x009c }
                r3 = r2
                r4 = r9
                r3.onLoadChildren(r4, r5, r6, r7, r8)     // Catch:{ BadParcelableException -> 0x009c }
                goto L_0x009b
            L_0x005a:
                r2.onConnectionFailed(r9)     // Catch:{ BadParcelableException -> 0x009c }
                goto L_0x009b
            L_0x005e:
                java.lang.String r3 = r1.getString(r4)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r4 = "data_media_session_token"
                android.os.Parcelable r4 = r1.getParcelable(r4)     // Catch:{ BadParcelableException -> 0x009c }
                android.support.v4.media.session.MediaSessionCompat$Token r4 = (android.support.v4.media.session.MediaSessionCompat.Token) r4     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r5 = "data_root_hints"
                android.os.Bundle r5 = r1.getBundle(r5)     // Catch:{ BadParcelableException -> 0x009c }
                r2.onServiceConnected(r9, r3, r4, r5)     // Catch:{ BadParcelableException -> 0x009c }
                goto L_0x009b
            L_0x0075:
                java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ BadParcelableException -> 0x009c }
                r3.<init>()     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r4 = "Unhandled message: "
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009c }
                r3.append(r12)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r4 = "\n  Client version: "
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009c }
                r3.append(r10)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r4 = "\n  Service version: "
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009c }
                int r4 = r12.arg1     // Catch:{ BadParcelableException -> 0x009c }
                r3.append(r4)     // Catch:{ BadParcelableException -> 0x009c }
                java.lang.String r3 = r3.toString()     // Catch:{ BadParcelableException -> 0x009c }
                android.util.Log.w(r0, r3)     // Catch:{ BadParcelableException -> 0x009c }
            L_0x009b:
                goto L_0x00a9
            L_0x009c:
                r3 = move-exception
