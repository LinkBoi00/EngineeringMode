        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 12:
                    ...
                    if (data.readInt() != 0) {
                        _arg3 = (ResultReceiver) ResultReceiver.CREATOR.createFromParcel(parcel);
                    } else {
                        _arg3 = null;
                    }
