...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Uri uri = new Uri.Builder().scheme(NfcCommand.MESSAGE_CONTENT_KEY).authority(str).build();
        Uri fileBaseUri = new Uri.Builder().scheme(NfcCommand.MESSAGE_CONTENT_KEY).authority(str).appendPath("file").build();
        Cursor cursor2 = null;
        try {
            int i = 0;
