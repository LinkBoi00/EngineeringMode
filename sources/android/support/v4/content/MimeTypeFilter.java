...
public final class MimeTypeFilter {
    ...
    public static boolean matches(String mimeType, String filter) {
        ...
        return mimeTypeAgainstFilter(mimeType.split(FileUtils.SEPARATOR), filter.split(FileUtils.SEPARATOR));
    }
    ...
    public static String matches(String mimeType, String[] filters) {
        ...
        String[] mimeTypeParts = mimeType.split(FileUtils.SEPARATOR);
        for (String filter : filters) {
            if (mimeTypeAgainstFilter(mimeTypeParts, filter.split(FileUtils.SEPARATOR))) {
                return filter;
            }
        }
        return null;
    ...
    public static String matches(String[] mimeTypes, String filter) {
        ...
        String[] filterParts = filter.split(FileUtils.SEPARATOR);
        for (String mimeType : mimeTypes) {
            if (mimeTypeAgainstFilter(mimeType.split(FileUtils.SEPARATOR), filterParts)) {
                return mimeType;
            }
        }
        return null;
