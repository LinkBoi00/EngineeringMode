...
public final class RadioAccessSpecifier {
    ...
    public static final class Bands {
        ...
        public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
            ...
            byte int8 = hwBlob.getInt8(_hidl_offset + 0);
            this.hidl_d = int8;
            switch (int8) {
                case 0:
                    this.hidl_o = new ArrayList();
                    ...
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
                        ((ArrayList) this.hidl_o).add(Integer.valueOf(childBlob.getInt32((long) (_hidl_index_0 * 4))));
                    }
                    return;
                case 1:
                    this.hidl_o = new ArrayList();
                    int _hidl_vec_size2 = hwBlob.getInt32(_hidl_offset + 8 + 8);
                    HwBlob childBlob2 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size2 * 4), _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
                    ((ArrayList) this.hidl_o).clear();
                    for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
                        ((ArrayList) this.hidl_o).add(Integer.valueOf(childBlob2.getInt32((long) (_hidl_index_02 * 4))));
                    }
                    return;
                case 2:
                    this.hidl_o = new ArrayList();
                    int _hidl_vec_size3 = hwBlob.getInt32(_hidl_offset + 8 + 8);
                    HwBlob childBlob3 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size3 * 4), _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
                    ((ArrayList) this.hidl_o).clear();
                    for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
                        ((ArrayList) this.hidl_o).add(Integer.valueOf(childBlob3.getInt32((long) (_hidl_index_03 * 4))));
                    }
                    return;
                case 3:
                    this.hidl_o = new ArrayList();
                    int _hidl_vec_size4 = hwBlob.getInt32(_hidl_offset + 8 + 8);
                    HwBlob childBlob4 = parcel.readEmbeddedBuffer((long) (_hidl_vec_size4 * 4), _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
                    ((ArrayList) this.hidl_o).clear();
                    for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size4; _hidl_index_04++) {
                        ((ArrayList) this.hidl_o).add(Integer.valueOf(childBlob4.getInt32((long) (_hidl_index_04 * 4))));
                    }
                    return;
                default:
        ...
        public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
            ...
            switch (this.hidl_d) {
                case 0:
                    ...
                    for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
                        childBlob.putInt32((long) (_hidl_index_0 * 4), geranBands().get(_hidl_index_0).intValue());
                    }
                ...
                case 1:
                    ...
                    for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size2; _hidl_index_02++) {
                        childBlob2.putInt32((long) (_hidl_index_02 * 4), utranBands().get(_hidl_index_02).intValue());
                    }
                ...
                case 2:
                    ...
                    for (int _hidl_index_03 = 0; _hidl_index_03 < _hidl_vec_size3; _hidl_index_03++) {
                        childBlob3.putInt32((long) (_hidl_index_03 * 4), eutranBands().get(_hidl_index_03).intValue());
                    }
                ...
                case 3:
                    ...
                    for (int _hidl_index_04 = 0; _hidl_index_04 < _hidl_vec_size4; _hidl_index_04++) {
                        childBlob4.putInt32((long) (_hidl_index_04 * 4), ngranBands().get(_hidl_index_04).intValue());
                    }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.radioAccessNetwork))), Integer.valueOf(HidlSupport.deepHashCode(this.bands)), Integer.valueOf(HidlSupport.deepHashCode(this.channels))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.bands.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 8);
        int _hidl_vec_size = hwBlob.getInt32(_hidl_offset + 32 + 8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 4), _hidl_blob.handle(), 0 + _hidl_offset + 32, true);
        this.channels.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * 4);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            childBlob.putInt32((long) (_hidl_index_0 * 4), this.channels.get(_hidl_index_0).intValue());
        }
