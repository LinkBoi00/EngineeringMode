...
public final class BarringInfo {
    ...
    public static final class ServiceType {
        ...
        public static final String dumpBitfield(int o) {
            ...
            if ((o & OPERATOR_26) == 1026) {
                list.add("OPERATOR_26");
                flipped |= OPERATOR_26;
            }
            if ((o & OPERATOR_27) == 1027) {
                list.add("OPERATOR_27");
                flipped |= OPERATOR_27;
            }
            if ((o & OPERATOR_28) == 1028) {
                list.add("OPERATOR_28");
                flipped |= OPERATOR_28;
            }
            if ((o & OPERATOR_29) == 1029) {
                list.add("OPERATOR_29");
                flipped |= OPERATOR_29;
            }
            if ((o & OPERATOR_30) == 1030) {
                list.add("OPERATOR_30");
                flipped |= OPERATOR_30;
            }
            if ((o & OPERATOR_31) == 1031) {
                list.add("OPERATOR_31");
                flipped |= OPERATOR_31;
            }
            if ((o & OPERATOR_32) == 1032) {
    ...
    public static final class BarringTypeSpecificInfo {
        ...
        public static final class Conditional {
            ...
            public final int hashCode() {
                return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.factor))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.timeSeconds))), Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.isBarred)))});
            }
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.serviceType))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.barringType))), Integer.valueOf(HidlSupport.deepHashCode(this.barringTypeSpecificInfo))});
    }
