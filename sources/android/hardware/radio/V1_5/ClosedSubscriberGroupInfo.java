...
public final class ClosedSubscriberGroupInfo {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Boolean.valueOf(this.csgIndication))), Integer.valueOf(HidlSupport.deepHashCode(this.homeNodebName)), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.csgIdentity)))});
    }
