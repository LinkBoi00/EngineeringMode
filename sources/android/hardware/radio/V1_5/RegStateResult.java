...
public final class RegStateResult {
    ...
    public static final class AccessTechnologySpecificInfo {
        ...
        public static final class EutranRegistrationInfo {
            ...
            public final int hashCode() {
                return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.lteVopsInfo)), Integer.valueOf(HidlSupport.deepHashCode(this.nrIndicators))});
            }
            ...
            public final void readFromParcel(HwParcel parcel) {
                readEmbeddedFromParcel(parcel, parcel.readBuffer(5), 0);
            }
            ...
            public static final ArrayList<EutranRegistrationInfo> readVectorFromParcel(HwParcel parcel) {
                ...
                HwBlob _hidl_blob = parcel.readBuffer(16);
                int _hidl_vec_size = _hidl_blob.getInt32(8);
                HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 5), _hidl_blob.handle(), 0, true);
                _hidl_vec.clear();
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
                    EutranRegistrationInfo _hidl_vec_element = new EutranRegistrationInfo();
                    _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * 5));
                    _hidl_vec.add(_hidl_vec_element);
                }
                return _hidl_vec;
            }
            ...
            public static final void writeVectorToParcel(HwParcel parcel, ArrayList<EutranRegistrationInfo> _hidl_vec) {
                ...
                for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
                    _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 5));
                }
                _hidl_blob.putBlob(0, childBlob);
                parcel.writeBuffer(_hidl_blob);
            }
    ...
    public final void readFromParcel(HwParcel parcel) {
        readEmbeddedFromParcel(parcel, parcel.readBuffer(224), 0);
    }
    ...
    public static final ArrayList<RegStateResult> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob _hidl_blob = parcel.readBuffer(16);
        int _hidl_vec_size = _hidl_blob.getInt32(8);
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * 224), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            RegStateResult _hidl_vec_element = new RegStateResult();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * 224));
            _hidl_vec.add(_hidl_vec_element);
        }
        return _hidl_vec;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.regState = hwBlob.getInt32(_hidl_offset + 0);
        this.rat = hwBlob.getInt32(_hidl_offset + 4);
        this.reasonForDenial = hwBlob.getInt32(_hidl_offset + 8);
        this.cellIdentity.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 16);
        String string = hwBlob.getString(_hidl_offset + 184);
        this.registeredPlmn = string;
        parcel.readEmbeddedBuffer((long) (string.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 184 + 0, false);
        this.accessTechnologySpecificInfo.readEmbeddedFromParcel(parcel, hwBlob, _hidl_offset + 200);
    }
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<RegStateResult> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * 224));
        }
        _hidl_blob.putBlob(0, childBlob);
        parcel.writeBuffer(_hidl_blob);
    }
