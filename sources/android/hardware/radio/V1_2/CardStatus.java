...
public final class CardStatus {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        String string = hwBlob.getString(_hidl_offset + 48);
        this.atr = string;
        parcel.readEmbeddedBuffer((long) (string.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 48 + 0, false);
        String string2 = hwBlob.getString(_hidl_offset + 64);
        this.iccid = string2;
        parcel.readEmbeddedBuffer((long) (string2.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 64 + 0, false);
    }
