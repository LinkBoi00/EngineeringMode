...
public final class SignalStrength {
    ...
    public static final ArrayList<SignalStrength> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer((long) (_hidl_vec_size * NfcCommand.CommandType.MTK_NFC_EM_ALS_CARD_MODE_RSP), _hidl_blob.handle(), 0, true);
        _hidl_vec.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            SignalStrength _hidl_vec_element = new SignalStrength();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, (long) (_hidl_index_0 * NfcCommand.CommandType.MTK_NFC_EM_ALS_CARD_MODE_RSP));
    ...
    public final void writeToParcel(HwParcel parcel) {
        HwBlob _hidl_blob = new HwBlob(NfcCommand.CommandType.MTK_NFC_EM_ALS_CARD_MODE_RSP);
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<SignalStrength> _hidl_vec) {
        ...
        HwBlob childBlob = new HwBlob(_hidl_vec_size * NfcCommand.CommandType.MTK_NFC_EM_ALS_CARD_MODE_RSP);
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, (long) (_hidl_index_0 * NfcCommand.CommandType.MTK_NFC_EM_ALS_CARD_MODE_RSP));
        }
