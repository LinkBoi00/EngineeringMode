...
public class SocketUtils {
    ...
    public static class BaseBuffer {
        ...
        public String toString() {
            ...
            o.append("BaseBuffer ");
            o.append("offset=[" + this.mOffset + "] ");
            o.append("maxSize=[" + this.mBuff.length + "] ");
            return o.toString();
        }
        ...
        public void putInt(int data) {
            ...
            putShort((short) (65535 & (data >> 16)));
        }

        public void putLong(long data) {
            putInt((int) (data & -1));
            putInt((int) (-1 & (data >> 32)));
        }
        ...
        public int getInt() {
            return 0 | (getShort() & 65535) | (getShort() << 16);
        }

        public long getLong() {
            return 0 | (((long) getInt()) & BandModeContent.LTE_MAX_VALUE) | (((long) getInt()) << 32);
        }
