...
class SecondaryCellRssiRx extends NormalTableComponent {
    ...
    public void update(String name, Object msg) {
        Msg data = (Msg) msg;
        int iRssiRx0 = getFieldValue(data, "dl_info[1]." + MDMContent.EM_EL1_STATUS_DL_INFO_DL_RSSI + "[0]", true);
        int iRssiRx1 = getFieldValue(data, "dl_info[1]." + MDMContent.EM_EL1_STATUS_DL_INFO_DL_RSSI + "[1]", true);
        clearData();
