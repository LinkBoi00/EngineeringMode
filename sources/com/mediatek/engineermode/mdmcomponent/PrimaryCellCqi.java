...
class PrimaryCellCqi extends CurveComponent {
    ...
    public void update(String name, Object msg) {
        Msg data = (Msg) msg;
        int cw0 = getFieldValue(data, "dl_info[0]." + MDMContent.EM_EL1_STATUS_DL_INFO_CQI_CW0, true);
        int cw1 = getFieldValue(data, "dl_info[0]." + MDMContent.EM_EL1_STATUS_DL_INFO_CQI_CW1, true);
        addData(0, (float) cw0);
        addData(0, (float) cw1);
    }
}
