...
public class MDMCoreOperation {
    ...
    public boolean mdmlClosing() {
        MONITOR_CMD_RESP ret = this.m_cmdProxy.onCloseSession(this.m_sid);
        MONITOR_CMD_RESP monitor_cmd_resp = ret;
    ...
    public void subscribeTrap() {
        ...
        Long[] array = (Long[]) this.mCheckedEmInteger.toArray(new Long[this.mCheckedEmInteger.size()]);
        Elog.d(TAG, "onSubscribeTrap msg id = " + Arrays.toString(array));
        this.m_cmdProxy.onSubscribeMultiTrap(this.m_sid, TRAP_TYPE.TRAP_TYPE_EM, toPrimitives(array));
    }
    ...
    public void unSubscribeTrap() {
        ...
        this.m_cmdProxy.onUnsubscribeMultiTrap(this.m_sid, TRAP_TYPE.TRAP_TYPE_EM, toPrimitives(array));
