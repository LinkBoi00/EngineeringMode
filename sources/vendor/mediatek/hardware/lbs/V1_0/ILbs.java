...
public interface ILbs extends IBase {
    ...
    public static abstract class Stub extends HwBinder implements ILbs {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ILbs.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{85, 62, 65, -65, 67, 94, 64, 108, 112, 12, 72, -79, -2, -98, 57, -26, -82, -112, -78, -126, -102, -83, 75, 93, -22, 100, 36, 50, 116, -75, -3, 76}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
