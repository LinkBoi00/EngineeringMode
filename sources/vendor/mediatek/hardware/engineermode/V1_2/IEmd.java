package vendor.mediatek.hardware.engineermode.V1_2;
...
public interface IEmd extends vendor.mediatek.hardware.engineermode.V1_1.IEmd {
    public static final String kInterfaceName = "vendor.mediatek.hardware.engineermode@1.2::IEmd";
    ...
    public static final class Proxy implements IEmd {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.engineermode@1.2::IEmd]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IEmd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IEmd.kInterfaceName, vendor.mediatek.hardware.engineermode.V1_1.IEmd.kInterfaceName, vendor.mediatek.hardware.engineermode.V1_0.IEmd.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-27, 21, -43, -90, 81, 55, -122, 15, -38, 41, 82, 89, 19, 22, -11, -38, 116, -21, -72, 107, 108, -20, 82, 17, -40, -117, 29, 113, -32, -38, 55, -26}, new byte[]{99, -93, 35, -85, -5, -25, 48, 13, -112, -127, 102, -26, 71, 112, 32, -43, 73, 58, 120, -17, -118, -84, 123, -14, -27, -42, -96, 67, -65, -69, -92, -113}, new byte[]{-66, -27, 18, -107, 121, -115, -5, -113, -11, 28, 119, -105, 121, -100, 105, -29, 86, 105, -79, 32, -9, 25, 54, -117, -93, -97, -29, -30, -10, -48, 79, -100}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
