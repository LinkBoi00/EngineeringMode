package vendor.mediatek.hardware.engineermode.V1_3;
...
public interface IEmd extends vendor.mediatek.hardware.engineermode.V1_2.IEmd {
    public static final String kInterfaceName = "vendor.mediatek.hardware.engineermode@1.3::IEmd";
    ...
    public static final class Proxy implements IEmd {
        ...
        public boolean setEmConfigure(String name, String value) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.engineermode.V1_1.IEmd.kInterfaceName);
        ...
        public int btIsEmSupport() throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(vendor.mediatek.hardware.engineermode.V1_2.IEmd.kInterfaceName);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public ArrayList<Byte> readMnlConfigFile(ArrayList<Integer> tag) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IEmd.kInterfaceName);
            _hidl_request.writeInt32Vector(tag);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public boolean writeMnlConfigFile(ArrayList<Byte> content, ArrayList<Integer> tag) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IEmd.kInterfaceName);
            _hidl_request.writeInt8Vector(content);
            _hidl_request.writeInt32Vector(tag);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void setNfcResponseFunction(IEmNfcResponse response) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IEmd.kInterfaceName);
            _hidl_request.writeStrongBinder(response == null ? null : response.asBinder());
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        public void sendNfcRequest(int ins, ArrayList<Byte> detail) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IEmd.kInterfaceName);
            _hidl_request.writeInt32(ins);
            _hidl_request.writeInt8Vector(detail);
            HwParcel _hidl_reply = new HwParcel();
            try {
    ...
    public static abstract class Stub extends HwBinder implements IEmd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IEmd.kInterfaceName, vendor.mediatek.hardware.engineermode.V1_2.IEmd.kInterfaceName, vendor.mediatek.hardware.engineermode.V1_1.IEmd.kInterfaceName, vendor.mediatek.hardware.engineermode.V1_0.IEmd.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-22, 12, 88, 52, -116, -101, -35, -76, -64, 82, -107, 125, -61, 84, -32, 119, -69, -36, -2, -56, 110, 107, -114, -117, -7, -34, 60, -36, 63, -60, 14, -109}, new byte[]{-27, 21, -43, -90, 81, 55, -122, 15, -38, 41, 82, 89, 19, 22, -11, -38, 116, -21, -72, 107, 108, -20, 82, 17, -40, -117, 29, 113, -32, -38, 55, -26}, new byte[]{99, -93, 35, -85, -5, -25, 48, 13, -112, -127, 102, -26, 71, 112, 32, -43, 73, 58, 120, -17, -118, -84, 123, -14, -27, -42, -96, 67, -65, -69, -92, -113}, new byte[]{-66, -27, 18, -107, 121, -115, -5, -113, -11, 28, 119, -105, 121, -100, 105, -29, 86, 105, -79, 32, -9, 25, 54, -117, -93, -97, -29, -30, -10, -48, 79, -100}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 45:
                    ...
                    return;
                case 46:
                    hwParcel.enforceInterface(vendor.mediatek.hardware.engineermode.V1_1.IEmd.kInterfaceName);
                    ...
                    return;
                case 47:
                    hwParcel.enforceInterface(vendor.mediatek.hardware.engineermode.V1_2.IEmd.kInterfaceName);
                    int _hidl_out_result12 = btIsEmSupport();
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(_hidl_out_result12);
                    _hidl_reply.send();
                    return;
                case 48:
                    hwParcel.enforceInterface(vendor.mediatek.hardware.engineermode.V1_2.IEmd.kInterfaceName);
                    int _hidl_out_result13 = isNfcSupport();
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(_hidl_out_result13);
                    _hidl_reply.send();
                    return;
                case 49:
                    hwParcel.enforceInterface(vendor.mediatek.hardware.engineermode.V1_2.IEmd.kInterfaceName);
                    int _hidl_out_result14 = isGauge30Support();
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt32(_hidl_out_result14);
                    _hidl_reply.send();
                    return;
                case 50:
                    hwParcel.enforceInterface(IEmd.kInterfaceName);
                    ArrayList<Byte> _hidl_out_data = readMnlConfigFile(_hidl_request.readInt32Vector());
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeInt8Vector(_hidl_out_data);
                    _hidl_reply.send();
                    return;
                case 51:
                    hwParcel.enforceInterface(IEmd.kInterfaceName);
                    boolean _hidl_out_success35 = writeMnlConfigFile(_hidl_request.readInt8Vector(), _hidl_request.readInt32Vector());
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeBool(_hidl_out_success35);
                    _hidl_reply.send();
                    return;
                case 52:
                    hwParcel.enforceInterface(IEmd.kInterfaceName);
                    setNfcResponseFunction(IEmNfcResponse.asInterface(_hidl_request.readStrongBinder()));
                    hwParcel2.writeStatus(0);
                    _hidl_reply.send();
                    return;
                case 53:
                    hwParcel.enforceInterface(IEmd.kInterfaceName);
                    boolean _hidl_out_success36 = connect();
                    hwParcel2.writeStatus(0);
                    hwParcel2.writeBool(_hidl_out_success36);
                    _hidl_reply.send();
                    return;
                case 54:
                    hwParcel.enforceInterface(IEmd.kInterfaceName);
                ...
                case 55:
                    hwParcel.enforceInterface(IEmd.kInterfaceName);
                    sendNfcRequest(_hidl_request.readInt32(), _hidl_request.readInt8Vector());
                    return;
                case 256067662:
