...
public interface IEmCallback extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.engineermode@1.0::IEmCallback";
    ...
    public static final class Proxy implements IEmCallback {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.engineermode@1.0::IEmCallback]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IEmCallback {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IEmCallback.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-27, 112, 36, 113, -82, 20, -75, -113, 38, -39, 101, -23, Byte.MIN_VALUE, -21, 119, 117, -10, 40, -108, 42, 29, -83, 7, -109, 100, 101, -90, 100, -55, 73, 93, -105}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
