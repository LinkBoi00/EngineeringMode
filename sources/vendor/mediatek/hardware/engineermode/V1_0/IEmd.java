package vendor.mediatek.hardware.engineermode.V1_0;
...
public interface IEmd extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.engineermode@1.0::IEmd";

    IHwBinder asBinder();

    int btDoTest(int i, int i2, int i3, int i4, int i5, int i6, int i7) throws RemoteException;

    ArrayList<Integer> btEndNoSigRxTest() throws RemoteException;

    ArrayList<Byte> btHciCommandRun(ArrayList<Byte> arrayList) throws RemoteException;
    ...
    boolean clearItemsforRsc() throws RemoteException;

    void debug(NativeHandle nativeHandle, ArrayList<String> arrayList) throws RemoteException;

    boolean genMdLogFilter(String str, String str2) throws RemoteException;

    DebugInfo getDebugInfo() throws RemoteException;

    boolean getFilePathListWithCallBack(String str, IEmCallback iEmCallback) throws RemoteException;
    ...
    boolean sendToServerWithCallBack(String str, IEmCallback iEmCallback) throws RemoteException;
    ...
    void setCallback(IEmCallback iEmCallback) throws RemoteException;
    ...
    boolean setOmxCoreLogEnable(String str) throws RemoteException;

    boolean setOmxVdecLogEnable(String str) throws RemoteException;

    boolean setOmxVencLogEnable(String str) throws RemoteException;
    ...
    boolean setSvpLogEnable(String str) throws RemoteException;
    ...
    boolean setVdecDriverLogEnable(String str) throws RemoteException;

    boolean setVencDriverLogEnable(String str) throws RemoteException;
    ...
    public static final class Proxy implements IEmd {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.engineermode@1.0::IEmd]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IEmd {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IEmd.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-66, -27, 18, -107, 121, -115, -5, -113, -11, 28, 119, -105, 121, -100, 105, -29, 86, 105, -79, 32, -9, 25, 54, -117, -93, -97, -29, -30, -10, -48, 79, -100}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
