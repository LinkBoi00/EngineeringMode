...
public interface IMwiRadioIndication extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@2.0::IMwiRadioIndication";
    ...
    public static final class Proxy implements IMwiRadioIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@2.0::IMwiRadioIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IMwiRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IMwiRadioIndication.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-117, -122, 79, -125, -54, -120, 96, -77, 73, -89, 36, 18, -80, -41, 39, -2, -123, 116, -29, -22, 19, -13, -53, 8, -120, 16, 15, 5, 9, 79, -49, -73}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
