...
public final class RsuResponseInfo {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.opId = hwBlob.getInt32(_hidl_offset + 0);
        this.requestId = hwBlob.getInt32(_hidl_offset + 4);
        this.errCode = hwBlob.getInt32(_hidl_offset + 8);
        ...
        this.time = hwBlob.getInt64(_hidl_offset + 32);
        this.version = hwBlob.getInt32(_hidl_offset + 40);
        this.status = hwBlob.getInt32(_hidl_offset + 44);
        this.reserveInt1 = hwBlob.getInt32(_hidl_offset + 48);
        this.reserveInt2 = hwBlob.getInt32(_hidl_offset + 52);
        String string2 = hwBlob.getString(_hidl_offset + 56);
