...
public interface ISERadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@2.0::ISERadioResponse";
    ...
    public static final class Proxy implements ISERadioResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@2.0::ISERadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISERadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISERadioResponse.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{52, -10, 104, -46, 36, 110, 53, -111, 120, 1, 97, 88, 44, -49, 34, -57, 118, -32, 94, 70, 55, 76, -124, 105, 112, -4, 122, -66, -5, -49, 125, 117}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
