...
public final class Tft {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.operation))), Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.pfNumber))), Integer.valueOf(HidlSupport.deepHashCode(this.pfList)), Integer.valueOf(HidlSupport.deepHashCode(this.tftParameter))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.operation = hwBlob.getInt32(_hidl_offset + 0);
        this.pfNumber = hwBlob.getInt32(_hidl_offset + 4);
        ...
        this.tftParameter.readEmbeddedFromParcel(hwParcel, hwBlob, _hidl_offset + 24);
    }
