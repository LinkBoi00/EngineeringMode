...
public interface ISmartRatSwitchRadioIndication extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@3.0::ISmartRatSwitchRadioIndication";
    ...
    public static final class Proxy implements ISmartRatSwitchRadioIndication {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@3.0::ISmartRatSwitchRadioIndication]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISmartRatSwitchRadioIndication {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{ISmartRatSwitchRadioIndication.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-76, -108, 13, 21, 52, -14, -119, 124, 29, -5, 40, -77, -60, 23, -77, -34, -93, -108, 13, -125, -7, -113, -83, 104, -91, 20, -69, 126, -91, 11, 20, -87}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
