...
public interface IImsRadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@3.0::IImsRadioResponse";
    ...
    public static final class Proxy implements IImsRadioResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@3.0::IImsRadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements IImsRadioResponse {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(new String[]{IImsRadioResponse.kInterfaceName, IBase.kInterfaceName}));
        }
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-76, 9, -77, 40, 12, -83, 34, 35, 52, 22, 107, -14, -31, -84, 42, 78, 101, -11, -57, -117, -35, 2, -119, -70, -24, 113, -60, 18, -49, 78, -97, 40}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
