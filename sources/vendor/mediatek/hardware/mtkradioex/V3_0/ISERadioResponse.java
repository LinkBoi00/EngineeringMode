...
public interface ISERadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@3.0::ISERadioResponse";
    ...
    public static final class Proxy implements ISERadioResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@3.0::ISERadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ISERadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{52, -104, -15, -69, -124, 47, 26, -38, 53, 97, -13, 79, -103, 96, 13, 17, 47, 90, -101, 39, -19, -10, -37, 31, 42, 37, 47, 72, 81, -118, 35, -10}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
