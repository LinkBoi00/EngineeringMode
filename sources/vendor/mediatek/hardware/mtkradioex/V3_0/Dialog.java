...
public final class Dialog {
    ...
    public boolean isCallHeld = false;
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.dialogId = hwBlob.getInt32(_hidl_offset + 0);
        this.callState = hwBlob.getInt32(_hidl_offset + 4);
        this.callType = hwBlob.getInt32(_hidl_offset + 8);
        this.isPullable = hwBlob.getBool(_hidl_offset + 12);
        this.isCallHeld = hwBlob.getBool(_hidl_offset + 13);
        this.isMt = hwBlob.getBool(_hidl_offset + 14);
