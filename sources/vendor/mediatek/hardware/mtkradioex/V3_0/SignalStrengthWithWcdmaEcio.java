...
public final class SignalStrengthWithWcdmaEcio {
    public int cdma_dbm = 0;
    public int cdma_ecio = 0;
    public int evdo_dbm = 0;
    public int evdo_ecio = 0;
    public int evdo_signalNoiseRatio = 0;
    public int gsm_bitErrorRate = 0;
    public int gsm_signalStrength = 0;
    public int lte_cqi = 0;
    public int lte_rsrp = 0;
    public int lte_rsrq = 0;
    public int lte_rssnr = 0;
    public int lte_signalStrength = 0;
    public int tdscdma_rscp = 0;
    public int wcdma_ecio = 0;
    public int wcdma_rscp = 0;
