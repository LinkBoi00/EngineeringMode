...
public final class OperatorInfoWithAct {
    ...
    public final int hashCode() {
        return Objects.hash(new Object[]{Integer.valueOf(HidlSupport.deepHashCode(this.base)), Integer.valueOf(HidlSupport.deepHashCode(this.lac)), Integer.valueOf(HidlSupport.deepHashCode(this.act))});
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        String string = hwBlob.getString(_hidl_offset + 56);
        this.lac = string;
        parcel.readEmbeddedBuffer((long) (string.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 56 + 0, false);
        String string2 = hwBlob.getString(_hidl_offset + 72);
        this.act = string2;
        parcel.readEmbeddedBuffer((long) (string2.getBytes().length + 1), _hidl_blob.handle(), _hidl_offset + 72 + 0, false);
    }
