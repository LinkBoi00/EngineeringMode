...
public interface ICapRadioResponse extends IBase {
    public static final String kInterfaceName = "vendor.mediatek.hardware.mtkradioex@3.0::ICapRadioResponse";
    ...
    public static final class Proxy implements ICapRadioResponse {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.mediatek.hardware.mtkradioex@3.0::ICapRadioResponse]@Proxy";
            }
        }
    ...
    public static abstract class Stub extends HwBinder implements ICapRadioResponse {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[][]{new byte[]{-53, 83, 4, -67, 51, 124, 15, 56, -78, 84, -74, 36, 81, 11, -18, 74, 77, 68, -114, -124, 63, 89, 116, 120, 43, 91, -3, -13, -67, 78, -96, -66}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}}));
        }
